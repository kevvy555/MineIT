...
const tech=read("js/ui/technology-presentation-ui.js"),enhanced=read("js/ui/ui-enhancements.js"),v55=read("js/ui/v55-ui.js");assert.match(tech,/technology\.tree/);assert.match(tech,/corporate-technology\.html/);assert.match(enhanced,/showFutureTech/);assert.match(enhanced,/HIDE FUTURE TECH/);assert.match(enhanced,/SHOW FUTURE TECH/);assert.match(enhanced,/HIDE OLD TECH/);assert.match(v55,/Extraction workforce/);assert.match(v55,/Natural Food workforce requirement/);assert.match(v55,/techEffect/);
