...
assert.equal(debt.largeHtmlTemplates,0,"Phase 4 is complete only when no genuine large application HTML templates remain in JavaScript");
assert.deepEqual(actualHtmlDebt,verifiedHtmlDebt,"Large HTML application templates must stay fully externalized");

for(const file of[
  "js/ui/v55-ui.js","js/ui/technology-presentation-ui.js","js/ui/land-ui.js","js/ui/colony-tech-ui.js",
  "js/ui/resource-ui.js","js/ui/ui-enhancements.js","js/ui/quick-trade-ui.js","js/ui/survival-ui.js",
  "js/ui/adaptive-building-ui.js","js/ui/contract-ui.js","js/ui/industry-ui.js","js/ui/building-details-ui.js",
  "js/ui/map-first-ui.js","js/ui/resource-development-ui.js"
])assert.ok(!largeHtmlTemplatesByFile.some(entry=>entry.file===file),`${file} large presentation templates must stay externalized`);

console.log("CleanUp architecture baseline guard passed with zero large HTML template debt");
