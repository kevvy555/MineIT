...
const pkg=JSON.parse(read("package.json")),index=read("index.html"),legacy=read("js/ui/ui-controller-v564.js"),help570=read("js/ui/ui-controller-v570.js"),help580=read("js/ui/ui-controller-v580.js"),help581=read("js/ui/ui-controller-v581.js");
assert.equal(pkg.version,"5.8.0");assert.match(index,/ui-controller-v581\.js\?v=5\.8\.0/);assert.match(legacy,/SurvivalUIMixin\.prototype\.help\.call\(this\)/);assert.match(help570,/super\.help\(\)/);assert.match(help580,/super\.help\(\)/);assert.match(help581,/super\.help\(\)/);
