...
const pkg=JSON.parse(read("package.json")),index=read("index.html"),legacy=read("js/ui/ui-controller-v564.js"),help570=read("js/ui/ui-controller-v570.js"),help580=read("js/ui/ui-controller-v580.js"),help581=read("js/ui/ui-controller-v581.js"),help582=read("js/ui/ui-controller-v582.js"),help590=read("js/ui/ui-controller-v590.js");
assert.equal(pkg.version,"5.9.0");assert.match(index,/ui-controller-v590\.js\?v=5\.9\.0/);assert.match(legacy,/SurvivalUIMixin\.prototype\.help\.call\(this\)/);assert.match(help570,/super\.help\(\)/);assert.match(help580,/super\.help\(\)/);assert.match(help581,/super\.help\(\)/);assert.match(help582,/super\.help\(\)/);assert.match(help590,/super\.help\(\)/);
...
console.log("v5.9.0 How to Play rules test passed");
