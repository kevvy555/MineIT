...
assert.match(ui,/adaptive-building-modal","full-screen-panel/);
assert.match(ui,/openHeadquartersColonyControl/);
...
assert.match(ui,/demolitionPanel\(tile\)|onDemolishDevelopment/);
assert.doesNotMatch(ui,/confirm\(`Demolish/);
