...
const art=read("js/ui/land-art.js"),view=read("js/ui/world-view-v56.js"),view570=read("js/ui/world-view-v570.js"),pkg=JSON.parse(read("package.json"));
...
assert.match(view570,/development\?\.kind!=="power"/);assert.match(view570,/P L\$\{level\}/,"Power buildings use an explicit vector fallback until a dedicated atlas is supplied");
...
console.log(`building artwork integration test passed (${families.length} atlases + Power fallback, ${total} bytes)`);
