...
assert.match(stateRuntime,/state\.version=14/);assert.match(stateRuntime,/ExpansionService/);assert.match(stateRuntime,/normalizeTechnologyState/);assert.match(stateRuntime,/normalizeSurveyHistoryAcrossPortfolio/);assert.match(stateRuntime,/lastScannedAtLevel/);assert.match(stateRuntime,/normalizeReputation/);
