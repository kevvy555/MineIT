...
const v56=read("js/ui/world-view-v56.js"),ui=read("js/ui/ui-controller.js"),ui56=read("js/ui/ui-controller-v56.js"),ui563=read("js/ui/ui-controller-v563.js"),ui564=read("js/ui/ui-controller-v564.js");
...
assert.match(ui564,/ui-controller-v563\.js\?v=5\.6\.3&legacy=1/);
assert.match(ui564,/survival-ui\.js\?v=5\.6\.4/);
assert.match(ui564,/extends V563UIController/);
assert.match(ui564,/help\.onclick=\(\)=>this\.help\(\)/);
assert.match(read("js/ui/v55-trade-ui-v56.js"),/extends LegacyTradeUI/);
console.log("MineIT v5.6.4 field-manual startup coherence test passed");
