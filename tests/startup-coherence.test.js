...
assert.match(simulation,/ExpansionService/);assert.match(simulation,/onColonyDied/);assert.match(simulation,/siteEnded/);assert.match(simulation,/technology\.processDay/);assert.match(simulation,/updateNetworks\(state,this\.collection\.activeSites/);assert.match(simulation,/changeReputation/);
