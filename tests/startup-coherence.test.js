...
assert.match(stateRuntime,/A08A_STATE_VERSION=15/);assert.match(stateRuntime,/ExpansionService/);assert.match(stateRuntime,/normalizeTechnologyState/);assert.match(stateRuntime,/normalizeSurveyHistoryAcrossPortfolio/);assert.match(stateRuntime,/lastScannedAtLevel/);assert.match(stateRuntime,/normalizeReputation/);
