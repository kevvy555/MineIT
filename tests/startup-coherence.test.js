...
assert.match(index,/colony-service-v562\.js\?v=5\.6\.2/);
assert.match(index,/site-service-v562\.js\?v=5\.6\.2/);
...
const v56=read("js/ui/world-view-v56.js"),ui=read("js/ui/ui-controller.js"),ui56=read("js/ui/ui-controller-v56.js");
...
console.log("MineIT v5.6.2 extraction-overdrive startup coherence test passed");
