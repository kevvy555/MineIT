...
const pkg=JSON.parse(read("package.json")),index=read("index.html"),controls=read("js/ui/map-controls-v580.js"),controls581=read("js/ui/map-controls-v581.js"),view=read("js/ui/world-view-v580.js"),ui=read("js/ui/ui-controller-v580.js"),ui581=read("js/ui/ui-controller-v581.js"),css=read("css/map-first.css");
assert.equal(pkg.version,"5.8.0");
assert.match(index,/map-first\.css\?v=5\.8\.0/);assert.match(index,/map-controls-v581\.js\?v=5\.8\.0/);assert.match(index,/world-view-v580\.js\?v=5\.8\.0/);assert.match(index,/ui-controller-v581\.js\?v=5\.8\.0/);
