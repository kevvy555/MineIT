...
assert.match(sellView,/SELL COLONY STOCK/);assert.match(buyView,/BUY FROM CORPORATION/);assert.match(colonists,/COLONIST TRANSFER/);assert.match(quick,/MAX_TRADE=100000/);assert.match(quick,/PAGE_SIZE=4/);assert.match(buyView,/data-buy-reserve/);assert.match(controller,/trade-reserve/);assert.match(controller,/tradeReserves/);assert.match(css,/trade-quick-modal \.modal-body\{overflow:hidden\}/);
