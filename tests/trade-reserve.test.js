...
const quick=readFileSync(new URL("../js/ui/quick-trade-ui.js",import.meta.url),"utf8"),colonists=readFileSync(new URL("../views/quick-trade-colonists.html",import.meta.url),"utf8"),controller=readFileSync(new URL("../js/ui/trade-reserve-ui.js",import.meta.url),"utf8"),css=readFileSync(new URL("../css/trade-quick.css",import.meta.url),"utf8");
assert.match(quick,/SELL COLONY STOCK/);assert.match(quick,/BUY FROM CORPORATION/);assert.match(colonists,/COLONIST TRANSFER/);assert.match(quick,/MAX_TRADE=100000/);assert.match(quick,/PAGE_SIZE=4/);assert.match(quick,/data-buy-reserve/);assert.match(controller,/trade-reserve/);assert.match(controller,/tradeReserves/);assert.match(css,/trade-quick-modal \.modal-body\{overflow:hidden\}/);
