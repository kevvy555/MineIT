...
const index=read("index.html"),portfolio=read("js/ui/portfolio-ui.js");
...
assert.match(portfolio,/CORPORATE SHIP DOCKED/);assert.match(portfolio,/ACTION REQUIRED/);assert.match(portfolio,/data-ship-waiting/);
