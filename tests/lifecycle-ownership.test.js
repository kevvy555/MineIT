...
const app=read("js/app.js"),baseUi=read("js/ui/ui-controller.js"),tradeUi=read("js/ui/trade-ui.js"),buyerUi=read("js/ui/buyer-ui.js"),world=read("js/ui/world-view-runtime.js"),mapFirst=read("js/ui/map-first-ui.js"),operational=read("js/ui/operational-controls-ui.js");
...
assert.match(app,/this\.buyerUI\?\.dispose\?\.\(\)/);assert.match(app,/this\.ui\?\.dispose\?\.\(\)/);assert.match(app,/this\.tradeUI\?\.dispose\?\.\(\)/);assert.match(app,/this\.view\?\.dispose\?\.\(\)/);assert.match(app,/this\.store\?\.dispose\?\.\(\)/);
...
assert.match(buyerUi,/dispose\(\)\{this\.catalogRevision\+\+;this\.collectionRevision\+\+/);assert.match(buyerUi,/this\.ui\.buyerUI=null/);
