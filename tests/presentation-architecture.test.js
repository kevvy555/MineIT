...
assert.doesNotMatch(cashUi,/prototype\.[A-Za-z0-9_$]+\s*=/);
...
assert.match(helpUi,/SurvivalUIMixin\.prototype\.help\.call\(this\)/);
assert.doesNotMatch(helpUi,/prototype\.[A-Za-z0-9_$]+\s*=/,"presentation adapters must not monkey-patch prototypes");
