...
assert.doesNotMatch(index,/map-controls-v58/,"map controls must resolve directly to the canonical module");assert.match(index,/corporate-trade-ui\.js/);assert.doesNotMatch(index,/quick-trade-ui-v511/,"corporate trade must resolve through the semantic adapter");
