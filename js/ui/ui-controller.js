import { formatNumber } from "../core/utils.js?v=4.0.3";
import { ResourceUIMixin } from "./resource-ui.js?v=4.0.3";
import { ColonyTechUIMixin } from "./colony-tech-ui.js?v=4.0.3";
import { ContractUIMixin } from "./contract-ui.js?v=4.0.3";
...
export class UIController {
  constructor({state,repo,resources,inventory,collection,colony,sites,technology,survey,contracts,world,icons,diagnostics,onHardReset,onNewContract,onRecalculate}){
    Object.assign(this,{state,repo,resources,inventory,collection,colony,sites,technology,survey,contracts,world,icons,diagnostics,onHardReset,onNewContract,onRecalculate});
  ...
  bind(){
    ...
    document.querySelector("#colonyBtn").onclick=()=>this.colonyPanel();
    ...
    document.querySelectorAll("[data-speed]").forEach(button=>button.onclick=()=>{this.state.speed=+button.dataset.speed;this.syncSpeed()});
...
mix(UIController,ResourceUIMixin);
mix(UIController,ColonyTechUIMixin);
mix(UIController,ContractUIMixin);
