import { UIController as V598UIController } from "./ui-controller-v598.js?v=5.9.8&legacy=1";
...
/** v5.9.9 replaces undeveloped resource details with the approved Variant 1 task-first panel. */
export class UIController extends V598UIController{
