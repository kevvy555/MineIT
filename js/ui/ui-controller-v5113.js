import { UIController as V5112UIController } from "./ui-controller-v5112.js?v=5.11.2&legacy=1";
import { PLAYER_SHIP_CAPACITY, PLAYER_SHIP_PASSENGERS } from "../domain/expansion-service.js?v=5.11.0";
...
/** v5.11.3 adds sortable planet data and a denser, load-focused ship-preparation screen. */
export class UIController extends V5112UIController{
