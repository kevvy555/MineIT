import { UIController as V592UIController } from "./ui-controller-v592.js?v=5.9.2&legacy=1";
import { formatNumber } from "../core/utils.js?v=5.5.5";

const ATLAS_COLUMNS=8;
const ATLAS_ROWS=5;

/** v5.9.8 adds the surveyed resource artwork to undeveloped resource details. */
export class UIController extends V592UIController{
