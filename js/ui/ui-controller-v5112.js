import { UIController as V5111UIController } from "./ui-controller-v5111.js?v=5.11.1&legacy=1";
...
/** v5.11.2 makes ship workflows deterministic, full-screen and internally navigable. */
export class UIController extends V5111UIController{
  constructor(opts){
    super(opts);this._shipNavActive=false;this.selectedStarSystemId=null;
    document.addEventListener("mineit:player-ship-clicked",()=>this.playerShipPanel());
  }
