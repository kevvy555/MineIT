...
export class UIController extends LegacyUIController{
  ...
  runAttentionAction(){const a=this.currentAttention||this.attentionStatus();if(a.focus){this.focusMap(a.focus);return;}if(a.action==="ship"){document.querySelector("#tradeBtn")?.click();return;}if(a.action==="colony")this.landColonyPanel();}
