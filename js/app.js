import { CONFIG } from "./core/config.js?v=4.0.3";
import { Diagnostics } from "./core/diagnostics.js?v=4.0.3";
import { ContractService } from "./domain/contract-service.js?v=4.0.3";
import { createGameState, normalizeState, starterInventory } from "./domain/game-state.js?v=4.0.3";
import { ResourceService } from "./domain/resource-service.js?v=4.0.3";
import { InventoryService } from "./domain/inventory-service.js?v=4.0.3";
import { CollectionService } from "./domain/collection-service.js?v=4.0.3";
import { ColonyService } from "./domain/colony-service.js?v=4.0.3";
import { TradeService } from "./domain/trade-service.js?v=4.0.3";
import { WorldService } from "./domain/world-service.js?v=4.0.3";
import { SiteService } from "./domain/site-service.js?v=4.0.3";
import { TechnologyService } from "./domain/technology-service.js?v=4.0.3";
import { SurveyService } from "./domain/survey-service.js?v=4.0.3";
import { SimulationEngine } from "./domain/simulation-engine.js?v=4.0.3";
import { SaveRepository } from "./persistence/save-repository.js?v=4.0.3";
import { ResourceIcons } from "./ui/resource-icons.js?v=4.0.3";
import { WorldView } from "./ui/world-view.js?v=4.0.3";
import { UIController } from "./ui/ui-controller.js?v=4.0.3";
import { TradeUI } from "./ui/trade-ui.js?v=4.0.3";
class MineITApp{
  constructor(){
